	...
	public void primitiveTypeProbing(){
			launchTest(new AbstractAgent(){
				protected void activate() {
					...
					FieldProbe<AbstractAgent,Integer> fp = new FieldProbe<AbstractAgent,Integer>(COMMUNITY,GROUP,ROLE,"privatePrimitiveField");
					s.addProbe(fp);
					assertTrue(1 == fp.getFieldValueFor(agent));
					FieldProbe<AbstractAgent,Double> fp2 = new FieldProbe<AbstractAgent,Double>(COMMUNITY,GROUP,ROLE,"publicPrimitiveField");
					s.addProbe(fp2);
	...
	public void wrongTypeProbing(){
			launchTest(new AbstractAgent(){
				protected void activate() {
					...
					Watcher s = new Watcher();
					assertEquals(SUCCESS,launchAgent(s));
					FieldProbe<AbstractAgent,String> fp = new FieldProbe<AbstractAgent,String>(COMMUNITY,GROUP,ROLE,"privatePrimitiveField");
					s.addProbe(fp);
					try {
