...
public class ACLMessage extends ActMessage // NO_UCD
{
	...
	protected static final List<String>			performatives				= new ArrayList<>(
																						22);
	 ...
	 * @serial
	 */
	private final ArrayList<AgentAddress>	replyTo						= new ArrayList<>();
	...
	public ACLMessage createReply() {
		...
		if (replyTo.isEmpty()) {
			...
			for (Iterator<AgentAddress> it = replyTo.iterator(); it.hasNext();) {
