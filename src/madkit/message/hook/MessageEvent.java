 ...
 * 
 */
public class MessageEvent extends EventMessage {

	/**
	 * 
	 */
	private static final long	serialVersionUID	= -4391416141048484284L;

	public MessageEvent(AgentActionEvent agentAction, Object[] infos) {
		super(agentAction, infos);
	}
	
	public Message getMessage(){
		return (Message) getContent()[1];
	}
