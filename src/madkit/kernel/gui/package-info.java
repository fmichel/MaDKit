...
* Especially, the {@link madkit.kernel.gui.IOPanel} class is the component which are
* given to agents when they are launched with a default GUI.
* Also the {@link madkit.kernel.gui.Utils} could be used to easily build agent GUI.
* 
