...
public class SimulationModel extends Watcher {
	 ...
	 * seeds should be chosen, is to take them in sequence.
	 * See this blog: <a href="https://www.johndcook.com/blog/2016/01/29/random-number-generator-seed-mistakes">Random number generator seed mistakes</a>
	 * So a simulation suite can be obtained by using this method with 
	 * a consecutive list of int: 1, 2, 3...
	 * 
	 * @param seedIndex
	 */
	 ...
	 */
	public void setRandomGnerator(RandomGenerator randomGnerator) {
		this.randomGenerator = randomGnerator;
	}
