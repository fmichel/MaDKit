	...
	public void cannotLaunch() {
		launchTest(new AbstractAgent() {
			...
			protected void activate() {
				launchAgentBucketWithRoles(FaultyAA.class.getName(), size,
						Arrays.asList(COMMUNITY + ";" + GROUP + ";" + ROLE));
			}
		});
	}
	...
	public void nullArg() {
		launchTest(new AbstractAgent() {
			...
			protected void activate() {
				...
				launchAgentBucketWithRoles(l,Arrays.asList(COMMUNITY + ";" + GROUP + ";" + ROLE));
			}
		});
	}
